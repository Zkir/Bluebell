...
$(geoextent)_admn_ad2_py_s4_osm_pp_adminboundary2: $(geoextent).o5m
	$(call generate_file,202_admn, --keep= --keep-relations="boundary=administrative and admin_level=6",write_poly)

$(geoextent)_admn_ad3_py_s4_osm_pp_adminboundary3: $(geoextent).o5m
	$(call generate_file,202_admn, --keep= --keep-relations="boundary=administrative and admin_level=8",write_poly)
